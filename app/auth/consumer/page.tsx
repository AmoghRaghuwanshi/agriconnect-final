...
export default function ConsumerLoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    setError('');
    setLoading(true);
    // TODO: connect to Supabase auth when keys are available
    setTimeout(() => {
      setLoading(false);
        ...
        <div style={{ width: '100%', maxWidth: '420px' }}>
          <div className="card" style={{ padding: '2.5rem' }}>
            ...
            <button
              ...
              onClick={() => setError('OAuth requires Supabase. Add real keys to .env.local.')}
            >
            ...
            <form onSubmit={handleLogin}>
              ...
              <button id="consumer-login-btn" type="submit" className="btn btn-primary" disabled={loading}
                style={{ width: '100%', justifyContent: 'center', marginTop: '0.5rem' }}>
                {loading ? <span className="spinner" style={{ width: '1rem', height: '1rem', borderTopColor: '#fff' }} /> : 'Sign In'}
              </button>
            </form>
