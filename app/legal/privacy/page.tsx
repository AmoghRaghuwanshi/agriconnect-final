      ...
      <div className="container" style={{ maxWidth: '760px', margin: '0 auto', padding: '3rem 1.5rem' }}>
        <div className="card" style={{ padding: '3rem' }}>
          ...
          {[
            ...
            { title: '3. Data Storage', body: 'All data is stored securely on Neon Serverless Postgres servers. Media files (produce images, avatars) are served via CDN distribution.' },
